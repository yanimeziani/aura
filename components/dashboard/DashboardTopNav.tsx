  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div ref={dropdownRef} className="relative">
        ...
        {open && (
          <div className="absolute right-0 z-50 mt-2 w-56 min-w-[calc(100vw-2rem)] max-w-72 overflow-hidden rounded-2xl border border-base-300 bg-base-200 py-1 shadow-xl">
