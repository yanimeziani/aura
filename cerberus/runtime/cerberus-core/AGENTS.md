# AGENTS.md — cerberus Agent Engineering Protocol
...
cerberus is a Zig-first autonomous AI assistant runtime optimized for:
...
src/
  ...
  config.zig            schema + config loading/merging (~/.cerberus/config.json)
