...
test "prepare outgoing content keeps unresolved relative attachment path" {
    ...
    const marker_text = "[IMAGE:cerberus_nonexistent_attachment_123456789.png]";
    ...
    try std.testing.expectEqualStrings("cerberus_nonexistent_attachment_123456789.png", prepared.attachments[0]);
}
