...
//! - Token storage with filesystem-based credential store (~/.cerberus/auth.json)
...
const CRED_DIR = ".cerberus";
const CRED_FILE = "auth.json";

/// Save a credential for the given provider to ~/.cerberus/auth.json.
...
/// Load a credential for the given provider from ~/.cerberus/auth.json.
...
/// Delete a credential for the given provider from ~/.cerberus/auth.json.
