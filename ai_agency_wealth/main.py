...
research_task = Task(
    description='Search the web for the top 3 trending "full auto" low-hanging fruit automated business models that can be run using open-source tools (like n8n, Ollama, CrewAI). Summarize their mechanics and how to launch them today.',
...
yield_task = Task(
    description='Search for USDC/USD yields AND research the top 3 HSA providers in Canada (Olympia, myHSA, Kibono) for a "Full Private Health" strategy. Recommend a monthly allocation.',
