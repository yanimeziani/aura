...
def generate_dynamic_offer():
    ...
    Create a professional infrastructure system offer.
    Respond ONLY with a valid JSON object in the following format:
    {{
        "title": "Multi-Agent Infrastructure System",
        "description": "Deploy autonomous infrastructure for continuous operation and systematic execution.",
        "price_usd": 9900,
        "features": ["Feature 1", "Feature 2", "Feature 3"]
    }}
    Make the price between 9900 and 49900 (in cents, so $99 to $499).
    Focus on operational efficiency, systematic execution, and infrastructure reliability.
    """
