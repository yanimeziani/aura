...
ws_portfolio_task = Task(
    description='Analyze the current USD yield options in Wealthsimple (Cash vs. Stocks/ETFs like CASH.TO or HISU.U). Recommend a strategy to maximize the USD in the user\'s Wealthsimple account while keeping risk low.',
