...
class PartitionSpec(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="The spec version ID")
    fields: List[PartitionField] = Field(description="Array of partition field definitions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "fields": [PartitionField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
