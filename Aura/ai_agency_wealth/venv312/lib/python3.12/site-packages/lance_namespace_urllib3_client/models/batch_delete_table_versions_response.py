...
class BatchDeleteTableVersionsResponse(BaseModel):
    """
    Response for deleting table version records
    """ # noqa: E501
    deleted_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of version records deleted")
    transaction_id: Optional[StrictStr] = Field(default=None, description="Optional transaction identifier")
    __properties: ClassVar[List[str]] = ["deleted_count", "transaction_id"]
