...
class TableBasicStats(BaseModel):
    ...
    TableBasicStats
    """ # noqa: E501
    num_deleted_rows: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of deleted rows in the table")
    num_fragments: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of fragments in the table")
