...
test "lark parse valid text message" {
    ...
    const payload =
        \\{"header":{"event_type":"im.message.receive_v1"},"event":{"sender":{"sender_id":{"open_id":"ou_testuser123"}},"message":{"message_type":"text","content":"{\"text\":\"Hello cerberus!\"}","chat_id":"oc_chat123","create_time":"1699999999000"}}}
    ;
    ...
    try std.testing.expectEqualStrings("Hello cerberus!", msgs[0].content);
