...
test "parseFunctionTagCall single parameter" {
    const allocator = std.testing.allocator;
    const inner = "<function=shell><parameter=command>ps aux | grep cerberus</parameter></function>";
    ...
    try std.testing.expect(std.mem.indexOf(u8, call.arguments_json, "ps aux | grep cerberus") != null);
...
test "parseToolCalls handles function-tag format inside tool_call" {
    ...
    const response =
        \\<tool_call>
        \\<function=shell>
        \\<parameter=command>ps aux | grep cerberus | grep -v grep</parameter>
        \\</function>
        \\</tool_call>
    ;
    const result = try parseToolCalls(allocator, response);
...
test "parseXmlToolCalls minimax format" {
    ...
    const response =
        ...
        \\<tool_call>
        \\<invoke name="shell">
        \\<parameter name="command">ls -la /home/micelio/.cerberus/workspace/amelie</parameter>
        \\</invoke>
        \\</minimax:tool_call>
    ;
...
test "parseXmlToolCalls minimax format robustness" {
    ...
    const response =
        \\Cloning...
        \\<tool_call>
        \\<invoke name="shell",<parameter name="command">ls -la /home/micelio/.cerberus/workspace/amelie</parameter>
        \\</invoke>
        \\</minimax:tool_call>
    ;
...
test "parseXmlToolCalls hybrid format" {
    ...
    const response =
        \\<tool_call>
        \\{"name": "shell", <parameter name="command">ls -la /home/micelio/.cerberus/workspace/amelie</parameter>
        \\</tool_call>
    ;
...
test "parseXmlToolCalls square bracket format" {
    ...
    const response =
        \\[TOOL_CALL]
        \\<invoke name="shell">
        \\<parameter name="command">ls -la /home/micelio/.cerberus/</parameter>
        \\</invoke>
        \\[/TOOL_CALL]
    ;
